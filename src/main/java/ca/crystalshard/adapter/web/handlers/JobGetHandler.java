...
public class JobGetHandler implements Route {

    private JobRepository jobRepository;
    private JobViewMapper jobViewMapper;

    @Inject
    public JobGetHandler(JobRepository jobRepository, JobViewMapper jobViewMapper) {
    ...
    public Object handle(Request request, Response response) throws Exception {
        ...
        if (job.isPresent())
            return jobViewMapper.toView(job.get());
